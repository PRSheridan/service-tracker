...
Revision ID: fd2e07ed05f9
Revises: 
Create Date: 2024-10-03 10:22:32.247189
...
def upgrade():
    ...
    sa.ForeignKeyConstraint(['queue_id'], ['queues.id'], name=op.f('fk_queue_tags_queue_id_queues')),
    sa.ForeignKeyConstraint(['tag_id'], ['tags.id'], name=op.f('fk_queue_tags_tag_id_tags')),
