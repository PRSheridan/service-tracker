...
function SignupForm({ onLogin }) {
    ...
    const formSchema = yup.object().shape({
        ...
        passwordConfirm: yup.string().oneOf([yup.ref('password'), null], "Passwords must match").required("Must confirm password"),
    });
        ...
        <form onSubmit={formik.handleSubmit}>
            ...
            <div>
                ...
                <input
                    ...
                    onChange={formik.handleChange}
                />
                <a style={{ color: "red" }}>{formik.errors.passwordConfirm}</a>
            </div>
            <div>
